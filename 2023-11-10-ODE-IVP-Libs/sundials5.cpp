// from: https://github.com/basilwong/simple-sundials/blob/master/more-sundials-examples/cvode/simple-dense-example/simple_dense_example.cpp
// compiles as: > g++ -std=c++17 -L /packages/spack/spack/opt/spack/linux-slackware15-x86_64/gcc-12.2.0/sundials-5.8.0-3qqstdwwck6mk46vswf2kwrbfnvmmz3p/lib64 sundials5.cpp -l sundials_cvode
/*
...
int main() {
  ...
  for (tout = step_length; tout <= end_time; tout += step_length) {
    ...
    //std::cout << "\ny:";
    //N_VPrint_Serial(y);
    std::cout << t << "\t" << NV_Ith_S(y, 0) << "\t" << NV_Ith_S(y, 1) << "\n";
